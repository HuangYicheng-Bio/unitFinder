...
#for Chrn in litt:
def completeGm4(Chrn,units,type1,seq1,alnpwd):
	pwd2='./Standards/CentGm-4-'+Chrn+'.complete.txt'
	pwd4='./Standards/CentGm-4-'+Chrn+'.complete.fa'
	pwd5='./Standards/CentGm-4-'+Chrn+'.complete.next.txt'
	pwd6='./Standards/CentGm-4-'+Chrn+'.complete.coords'
	...
	#	print (gseq.seq)
		...
		#	print (l)
			...
			if len(set(match1))>=300 and len(set(match2))>=300:#and float(alnt[6])>=80:
				print ('Good')
				dicte[k]=[alnt,flt]
				dictue[k]=[gseq,sn,en]
