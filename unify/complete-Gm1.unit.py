...
pwd1='../../../12-ZH13/Type/CentGm-1.type.fa'
#pwd1='./Jack.Type-TypeGroup/Type-10-typic.fasta'
pwd11='CentGm-1.fa'
#pwd11='../ref/Chr01-TypeGroup/Type-16-all.fasta'
pwd2='CentGm-1-stan.fa'
pwd3='CentGm-1-s-odd.fa'
file1=open(pwd2,'w')
file12=open(pwd3,'w')
list1=[]
for gseq in SeqIO.parse(pwd11,'fasta'):
	cp=gseq.description.split('\t')[1].split('-')[1]
	if len(gseq.seq)>80 and float(cp)>=50  and len(gseq.seq)<100:
		list1.append(gseq)
